...
`curl -X POST -H "Content-Type: application/json" -d '{"text": "✅ Plan Created: PLAN.md is ready for review."}' $FINCLAUDE_WEBHOOK`
(If $FINCLAUDE_WEBHOOK is not set, print a friendly "Plan Ready" message instead).
</system_prompt>
